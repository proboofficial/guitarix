...
#ifdef __APPLE__ //XCompatibility

#pragma once

#ifndef XPUTTY_MACOS_H_
#define XPUTTY_MACOS_H_

#ifdef __OBJC__   // Clean Cpp compatibility
...
// forward definitions for codepage tools in xwidget-macos.mm

char *convert_cp(unsigned int cp_from, unsigned int cp_to, char *s_from);
...
typedef struct {
  ...
  unsigned short vk; // No VK on macOS; use unsigned short for virtual key code
} XEvent;
...
// macOS doesn't have VK_* macros – use ASCII or define manually
...
#endif //XPUTTY_MACOS_H_

#endif //__APPLE__ //XCompatibility
